...
function Table() {
    return (
        <div class="container mx-auto px-4 sm:px-9">
  <div class="py-8">
    <div>
      <h2 class="text-2xl text-white text-center font-semibold leading-tight">Gun Spotted Warnings</h2>
    </div>
            ...
            <tr>
              ...
              <td class="px-5 py-5 bg-white text-sm">
                ...
                >
                  ...
                  ></span>
                  <span class="relative">ALERT</span>
                </span>
              </td>
